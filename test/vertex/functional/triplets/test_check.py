...
class TestIsCCW2D(unittest.TestCase):
    ...
    def test_ccw_points(self):
        ...
        # Points forming a counter-clockwise turn: (0.0,0.0) -> (1.0,0.0) -> (1.0,1.0)
        v1 = Vertex2D(0.0, 0.0)
        v2 = Vertex2D(1.0, 0.0)
        v3 = Vertex2D(1.0, 1.0)
    ...
    def test_cw_points(self):
        ...
        # Points forming a clockwise turn: (0.0,0.0) -> (1.0,0.0) -> (1.0,-1.0)
        v1 = Vertex2D(0.0, 0.0)
        v2 = Vertex2D(1.0, 0.0)
        v3 = Vertex2D(1.0, -1.0)
    ...
    def test_colinear_points(self):
        ...
        # Colinear points: (0.0,0.0) -> (1.0,0.0) -> (2.0,0.0)
        v1 = Vertex2D(0.0, 0.0)
        v2 = Vertex2D(1.0, 0.0)
        v3 = Vertex2D(2.0, 0.0)
        self.assertFalse(is_ccw_2d(v1, v2, v3))
...
class TestIsCCW3D(unittest.TestCase):
    ...
    def test_raises_not_implemented(self):
        ...
        v1 = Vertex3D(0.0, 0.0, 1.0)
        v2 = Vertex3D(1.0, 0.0, 2.0)
        v3 = Vertex3D(1.0, 1.0, 3.0)
...
class TestIsCCW(unittest.TestCase):
    ...
    def test_custom_vertex2d_subclass_works(self):
        ...
        # Points forming a counter-clockwise turn: (0.0,0.0) -> (1.0,0.0) -> (1.0,1.0)
        v1 = CustomVertex(0.0, 0.0)
        v2 = CustomVertex(1.0, 0.0)
        v3 = CustomVertex(1.0, 1.0)
        self.assertTrue(is_ccw(v1, v2, v3))
