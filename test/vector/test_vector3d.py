...
class TestVector3D:
    ...
    def test_vector3d_equality(self):
        ...
        vec2 = Vector3D(x=1.0, y=2.0, z=3.0)
        vec3 = Vector3D(x=1.0, y=2.0, z=4.0)
    ...
    def test_vector3d_less_than(self):
        ...
        vec1 = Vector3D(x=1.0, y=2.0, z=3.0)
        vec2 = Vector3D(x=2.0, y=2.0, z=3.0)
        vec3 = Vector3D(x=1.0, y=3.0, z=3.0)
    ...
    def test_vector3d_addition_error(self):
        ...
        with pytest.raises(TypeError) as exc_info:
            vec + "not_vector"
        assert str(exc_info.value) == "__add__ is only supported for Vector3D instances."

    def test_vector3d_subtraction(self):
        """Test vector subtraction."""
        vec1 = Vector3D(x=5.0, y=7.0, z=9.0)
        vec2 = Vector3D(x=2.0, y=3.0, z=4.0)
        result = vec1 - vec2
    ...
    def test_vector3d_subtraction_error(self):
        ...
        with pytest.raises(TypeError) as exc_info:
            vec - "not_vector"
        assert str(exc_info.value) == "__sub__ is only supported for Vector3D instances."

    def test_vector3d_norm_default(self):
        """Test norm calculation with default p=2."""
        vec = Vector3D(x=2.0, y=3.0, z=6.0)
        result = vec.norm()
    ...
    def test_vector3d_norm_custom_p(self):
        ...
        vec = Vector3D(x=1.0, y=1.0, z=1.0)
